...
class History(models.Model):
    ...
    filenamepdf = models.CharField(max_length=100,null=True)
    totalaccountspdf = models.CharField(max_length=100,null=True)
    totalpagespdf = models.CharField(max_length=100,null=True)
    firstrecordpdf = models.CharField(max_length=100,null=True)
    lastrecordpdf = models.CharField(max_length=100,null=True)
    programnamepdf = models.CharField(max_length=100,null=True)
