...
def TAX_INV(request,files1):
    ...
    def Folder_creation(cppp):
        ...
        outp = Scheduler.objects.filter(PROGRAM_NAME='TAX_INV').values()
        res = []
        otp = []
    ...
    for i in range(0,total_clients):
        ...
        pdf.image(r'E:\IWOC\APP SCRIPT\TAX_INVOICE\CYCLE\TAX_INVOICE\DATA\BSN_Reminder-02.jpg',20,146,80)
        pdf.image(r'E:\IWOC\APP SCRIPT\TAX_INVOICE\CYCLE\TAX_INVOICE\DATA\BSN_Reminder-02 - Copy.jpg', 145,146,40)

        pdf.ln(1)
        new_code  = 'b' + str(count)
        pdf.image(r'E:\IWOC\EXTRA\barcode_for_tax\%s.png'%(new_code),35,212,40)
        ...
        pdf.cell(-34)
        pdf.cell(10,278,txt = '00' + str(count))
    ...
    import PyPDF2
    file = open(r"%s\tax_invoce.pdf"%kk, 'rb')
