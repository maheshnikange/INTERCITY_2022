...
from os import path
from APP.models import History,DetailActivity,Scheduler
import datetime
...
def BKRCC(request,files1):
    ...
    def Folder_creation(cppp):
        ...
        # import os
        # directory = d
        outp = Scheduler.objects.filter(PROGRAM_NAME='BKRCC').values()
        res = []
    ...
    def table3():
        with open(path11)as infile: 
            ...
            k3 = []
            # for line in infile:
            for p in range(0,len(total_lines)):
    ...
    with open(path11)as file:
        for i in range(0,len(total_lines)):
            ...
            if line.startswith('CH00'):
                acc_start.append(i)
    acc_start.append(len(total_lines)-1)
        ...
        while c<lenght:
            ...
            for i in range(a,b):
                ...
                if line.startswith('TP'):
                    flag=True
                    TP.append(line[2:26])
                    TP.append(line[26:34])     #28
                    TP.append(line[71:79])     # 71:78
                    TP.append(line[78:83].strip())    # 78:83
                    TP.append(line[85:87])
                    TP.append(line[95:103])
            if flag==False:
                TP.append('TEST')
            c=c+1
            Tp_final.append(TP) 
    ...
    # print(Tp_final,len(Tp_final),'-0---------------------------0---------------000----')
    ...
    #------------------------------------------------ADDING 3RD PAGE TABLE OF TR RECORDS--------------
        ...
        if Tp_final[i] != b:
            ...
            if len(Tp_final[i])>=12 and len(Tp_final[i])<=18:
                pdf.ln(1)
                pdf.cell(4)
                pdf.cell(10,135 ,txt = str(Tp_final[i][6]))  
                pdf.cell(55)
                a = str(Tp_final[i][8])
                a  = str(a)
                n  = len(a)
                a = a[0:1] + ',' + a[1:n-1] +   a[n-1:]
                pdf.cell(10,135,txt = str(a))
                pdf.cell(20)
                if len(Tp_final[i][3]) == 3:
                    a = '0' + Tp_final[i][9]
                    pdf.cell(10,135,txt  =str(a))
                else:
                    pdf.cell(10,135,txt = Tp_final[i][9])
                pdf.cell(25)
                pdf.cell(10,135,txt = str(Tp_final[i][10]))
                pdf.cell(25)
                a = Tp_final[i][11]
                a = str(a)
                n = len(a)
                ...
                pdf.ln(1)
                pdf.cell(4)
                pdf.cell(10,145,txt =str(Tp_final[i][7]))

            if len(Tp_final[i])>=18 and len(Tp_final[i])<=24:
                pdf.ln(1)
                pdf.cell(4)
                pdf.cell(10,155 ,txt = str(Tp_final[i][12]))  
                pdf.cell(55)
                a = str(Tp_final[i][14])
                a  = str(a)
                n  = len(a)
                a = a[0:1] + ',' + a[1:n-1] +   a[n-1:]
                pdf.cell(10,155,txt = str(a))
                pdf.cell(20)
                if len(Tp_final[i][3]) == 3:
                    a = '0' + Tp_final[i][15]
                    pdf.cell(10,155,txt  =str(a))
                else:
                    pdf.cell(10,155,txt = Tp_final[i][15])
                pdf.cell(25)
                pdf.cell(10,155,txt = str(Tp_final[i][16]))
                pdf.cell(25)
                a = Tp_final[i][17]
                a = str(a)
                n = len(a)
                ...
                pdf.ln(1)
                pdf.cell(4)
                pdf.cell(10,165,txt =str(Tp_final[i][13]))
            
            if len(Tp_final[i])>=24 and len(Tp_final[i])<=30:
                pdf.ln(1)
                pdf.cell(4)
                pdf.cell(10,175 ,txt = str(Tp_final[i][18]))  
                pdf.cell(55)
                a = str(Tp_final[i][20])
                a  = str(a)
                n  = len(a)
                a = a[0:1] + ',' + a[1:n-1] +   a[n-1:]
                pdf.cell(10,175,txt = str(a))
                pdf.cell(20)
                if len(Tp_final[i][3]) == 3:
                    a = '0' + Tp_final[i][21]
                    pdf.cell(10,175,txt  =str(a))
                else:
                    pdf.cell(10,175,txt = Tp_final[i][21])
                pdf.cell(25)
                pdf.cell(10,175,txt = str(Tp_final[i][22]))
                pdf.cell(25)
                a = Tp_final[i][23]
                a = str(a)
                n = len(a)
                ...
                pdf.ln(1)
                pdf.cell(4)
                pdf.cell(10,185,txt =str(Tp_final[i][19]))
            
            if len(Tp_final[i])>=30 and len(Tp_final[i])<=36:
                pdf.ln(1)
                pdf.cell(4)
                pdf.cell(10,195 ,txt = str(Tp_final[i][24]))  
                pdf.cell(55)
                a = str(Tp_final[i][26])
                a  = str(a)
                n  = len(a)
                a = a[0:1] + ',' + a[1:n-1] +   a[n-1:]
                pdf.cell(10,195,txt = str(a))
                pdf.cell(20)
                if len(Tp_final[i][3]) == 3:
                    a = '0' + Tp_final[i][27]
                    pdf.cell(10,195,txt  =str(a))
                else:
                    pdf.cell(10,195,txt = Tp_final[i][27])
                pdf.cell(25)
                pdf.cell(10,195,txt = str(Tp_final[i][28]))
                pdf.cell(25)
                a = Tp_final[i][29]
                a = str(a)
                n = len(a)
                ...
                pdf.ln(1)
                pdf.cell(4)
                pdf.cell(10,205,txt =str(Tp_final[i][25]))
...
#-----------------------------------------printing close-------------------------------
    ...
    # data = History.objects.create(Date = str(today),Start = str(start_time),Finish=str(end_time),User = str(user) ,Product = 'KKK', File= str(files1),Status = 'Enable',Log = str(count),ActiveCount = str(total_clients),Page = str(totalpages),Impression  = 'DONE',filenamepdf = 'Combine.pdf',totalaccountspdf = str(total_clients),totalpagespdf =str(totalpages), firstrecordpdf = str(df2['credit no'].iat[0]),lastrecordpdf= str(df2['credit no'].iat[-1]), programnamepdf = 'BKRCC')                                                                                                                                                                                                                        
    first_record = df2['credit no'].iat[0]
    last_record= df2['credit no'].iat[-1]
    ffname = 'Combine.pdf'
